...
from tools.appointment_tools import suggest_available_slots, book_appointment, cancel_appointment_by_id, reschedule_appointment, parse_appointment_datetime
...
async def main():
    ...
    print(parse_appointment_datetime("Tuesday"))
